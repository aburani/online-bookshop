            ...
            <div class="row">
                ...
                <div class="col-md-2 hidden-sm hidden-xs">
                    <div class="nav-list affix">  
                        <div class="ShoppingCartHead"><div style="padding:10px;">YU CASH PAYMENT</div></div><br/>
<!-----START------->
<!--<!doctype html>
<html lang="en">
<head>
...
<div id="products">
  <h5 class="ui-widget-header">YU PAYMENT TERMS</h5>
  <div id="catalog">
                    ...
                    <div class="container">
                        <div class="col-md-10">
							...
							<div style="margin-top: 20px; ">
                                <b>YU Payment Order Customer Delivery Details Form. Fill your Details and Confirmation Code Below.</b>
                            </div>
                            <div style="margin-top: 20px;">
                                <form action="BootstrapShoppingCart/yu_on_delivery_send.php" method="post" id="form" name="form">
                                    <div class="row">
                                        <div class="col-md-3">
...
<label><span class="control-label">YU CASH Confirmation Code*</span></label>
                                            <input type="text" value="" class="form-control validate[required]" name="mpesa_code"  id="mpesa_code"   placeholder="YU CASH Confirmation Code">
                                            <div style="color:#b22222; font-size:10px; line-height: 10px; padding-bottom: 10px;">Your YU CASH CODE <!--<a href="#"><b> <h5>HELP! What is Payment Code?</h5> </a> </b>---></div>                                         
...
<div style="position:absolute;left:714px;top:50px;color:brown"> 
                                               <ul class="btn btn-success"  ><b> [] YU PAYMENT STEPS []</p></b></ul>
 <?php
                        $total = 0; // ShoppingCart Total
                        $subtotal=0;
                        $cart = new shoppingcart(); // init shoppingcart
                       ...
                       /*if (EW_CASHONDELIVERY > 0) {
                        ...
                        ?></p>
1. Go to YU CASH on your phone</p>
...
6. Enter your YU CASH PIN and Send</p>
7. You will receive a confirmation SMS from YU CASH with a Confirmation Code.</p>
...
9. Click on Submit Your Purchase Order</p>
                                    ...
                                    <input type="hidden" name="payment_status" value="YU CASH Before Delivery">
