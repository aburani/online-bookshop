...
<html lang="en">
    <head>
        ...
        <!--PICK THIS 3 FILES AND EDIT THEM AND OUT THEM INSIDE THE HEADE AT THE INC MENU PAGE/ FILE TO AVOID CHANGE OF BACK GROUND AND THE OTHERS--->

        <!--<title>Africa Herald Bookstore</title>-->
        <!--<link href="admin/img/chmsc.png" rel="icon" type="image">-->
        <link href="admin/css/bootstrap_2.css" rel="stylesheet" type="text/css" media="screen">
        <!--<link href="admin/css/bootstrap-responsive_2.css" rel="stylesheet" type="text/css" media="screen">-->
        <link href="admin/css/font-awesome.min_2.css" rel="stylesheet" type="text/css" media="screen">
        <!--<link rel="stylesheet" type="text/css" href="admin/css/DT_bootstrap.css">-->
        <?php /*?><?php include('admin/connect.php'); ?><?php */?>
    </head>
