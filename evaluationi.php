                ...
                <div class="hero-unit-3">
                    <div class="row-fluid">
                        <div class="span12">
							...
							<!--<marquee>-->
<b style="color:#006600; scrollamount:40000">Bookstore Shopping Sales Order Payment Method Highest Amount in Pie Chart Representation</br> </b> 
							</marquee>
...
<h5>Highest Amount of Payment Method</h5>
...
<html>
	...
	<!--<meta http-equiv="Content-Type" content="text/html; charset=utf-8">-->
		...
		$(document).ready(function() {
	        ...
	        $.getJSON("PC/data2.php", function(json) {
...
<b style="color:#006600; scrollamount:40000">Bookstore Shopping Sales Order Payment Method Highest Amount in Bar Chart Representation</br> </b> 
							</marquee>
							</div>
</center>
<!--2 CHART START--------------------------------------------------------------------------------------------------------->
