...
require_once "BootstrapShoppingCart/BootstrapShoppingCart.php";     // load class ahpShoppingCart
?>
<!DOCTYPE html>
                    ...
                    <div class="container"> 
                        <div class="col-md-10">
                            ...
                            if (!$cart->get_cart()) {  //checking if the cart is empty or not
                                ...
                                echo "<a href='" . $_SESSION['LastProductPage'] . "'><h4><b><< Go back </b></h4></a>"; // return to last product page
