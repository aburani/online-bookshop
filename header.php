<!DOCTYPE html>
<html lang="en">
    <head><!-----contains the background image for the main page------->

        <title>Africa Herald Bookstore</title>
        <link href="admin/img/chmsc.png" rel="icon" type="image">
        <link href="admin/css/bootstrap.css" rel="stylesheet" type="text/css" media="screen"> <!--BACKGROUND IMAGE..index.php-->
