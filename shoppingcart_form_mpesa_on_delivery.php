            ...
            <div class="row">
                ...
                <div class="col-md-2 hidden-sm hidden-xs">
                    <div class="nav-list affix">  
                        <div class="ShoppingCartHead"><div style="padding:10px;">M-MPESA PAYMENT</div></div><br/>
<!-----START------->
<!--<!doctype html>--->
<!--<html lang="en">
<head>
...
<div id="products">
  <h5 class="ui-widget-header">M-PESA PAYMENT TERMS</h5>
  <div id="catalog">
                    ...
                    <div class="container">
                        <div class="col-md-10">
							...
							<div style="margin-top: 20px; ">
                                <b>M-PESA Payment Order Customer Delivery Details Form. Fill your Details and Payment Code Below.</b>
                            </div>
                            <div style="margin-top: 20px;">
                                <form action="BootstrapShoppingCart/mpesa_on_delivery_send.php" method="post" id="form" name="form">
                                    <div class="row">
                                        <div class="col-md-3">
...
<label><span class="control-label">M-PESA Confirmation Code*</span></label>
                                            <input type="text" value="" class="form-control validate[required]" name="mpesa_code"  id="mpesa_code"   placeholder="M-PESA Confirmation Code">
                                            <div style="color:#b22222; font-size:10px; line-height: 10px; padding-bottom: 10px;">Your M-PESA CODE </div> <!--<a href="#"><b> <h5>HELP! What is Confirmation Code?</h5> </a> </b></div>--->                                         
 ...
 <!--<div style="margin-top: -350px; right: -160px;">-->
 <div style="position:absolute;left:714px;top:50px;color:brown"> 
                                               <ul class="btn btn-success"  ><b> [] MPESA PAYMENT STEPS []</p></b></ul>
 <?php
                        $total = 0; // ShoppingCart Total
                        $subtotal=0;
                        $cart = new shoppingcart(); // init shoppingcart
                       ...
                       /*if (EW_CASHONDELIVERY > 0) {
                        ...
                        echo "<br /><span class='price'>Get Confirmation Code. Send to Pay Bill Business number 572632 a Total of : " . moneyformat($subtotal) . "</span>"; 

                        ?></p>
1. Go to MPESA on your phone</p>
2. Select Pay Bill option</p>
3. Enter Business no. 572632</p>
4. Enter your National ID/Passport in Account NO</p>
5. Enter the Total Amount of Charges</p>
6. Enter your M-PESA PIN and Send</p>
7. You will receive a confirmation SMS from M-PESA with a Confirmation Code.</p>
8. After you receive the confirmation SMS enter the Confirmation Code</p>
9. Click on Submit Your Purchase Order</p>
                                    ...
                                    <input type="hidden" name="payment_status" value="M-PESA Before Delivery">
