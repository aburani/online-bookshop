            ...
            <div class="row">
                ...
                <div class="col-md-2 hidden-sm hidden-xs">
                    <div class="nav-list affix">  
                        <!--<div class="ShoppingCartHead"><div style="padding:10px;">M-PESA PAYMENT</div></div><br/>-->
                                ...
                                <form action="BootstrapShoppingCart/mpesa_on_delivery_send.php" method="post" id="form" name="form">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <div style="color:#b22222; font-size:10px; line-height: 10px; padding-bottom: 10px;">Please provide your zip code</div>
...
<label><span class="control-label">M-PESA Payment Code*</span></label>
                                            <input type="text" value="" class="form-control validate[required]" name="mpesa_code"  id="mpesa_code"   placeholder="M-PESA Payment Code">
                                            <div style="color:#b22222; font-size:10px; line-height: 10px; padding-bottom: 10px;">Your M-PESA CODE <a href="#"><b> <h5>HELP! What is Payment Code?</h5> </a> </b></div>                                         
...
<div class="navbar-inner">
        <div class="footerindex">
            <img width="75" height="45" src="images/aa.png">&nbsp;Copyright &copy; 2016 Africa Herald Publishing House |  Created by <a href="http://facebook.com/jakendujnr" target="_blank"> <b> nicosoft Developers </b></a>
